...
import { IFinderWpProps, IFinderWpStateOLD } from '../interfaces/IFinderWpProps';
...
export default class FinderWp extends React.Component<IFinderWpProps, IFinderWpStateOLD, {}> {
